...
public class StockPDF {
    ...
    private static final String TAG   = StockPDF.class.getSimpleName();
    ...
    private static void createTopDataTable(Document doc, String station) throws DocumentException {
        ...
        PdfPCell cell;
        {
            ...
            cell = new PdfPCell(new Phrase(station + " STOCK LEVEL", FONT_MID_TEXT));
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setUseBorderPadding(true);
            cell.setBorder(Rectangle.BOTTOM);
    ...
    private static PdfPTable createDataTable(List<String[]> dataTable) throws DocumentException
    {
        ...
        table1.setWidthPercentage(100);
        table1.setWidths(new float[]{1f,1f,1.5f,0.7f});
        ...
        PdfPCell cell;
        {
            cell = new PdfPCell(new Phrase("STATION", FONT_COLUMN));
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setBorder(Rectangle.NO_BORDER);
            ...
            cell = new PdfPCell(new Phrase("ITEM", FONT_COLUMN));
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setBorder(Rectangle.NO_BORDER);
            cell.setBackgroundColor(BaseColor.BLUE.darker());
